  ...
  describe('calendar.controller', function() {
    ...
    describe('layoutEvents', function () {
      it('layout 4 events on container with size 620*720', function () {
        ...
        var aExpected = [
          { id: 1, start: 60, end: 120, left: 10, top: 60, width: 300, height: 60},  // an event from 10am to 11am
          { id: 2, start: 100, end: 240, left: 310, top: 100, width: 300, height: 140}, // an event from 10:40am to 1pm
          { id: 3, start: 700, end: 720, left: 10, top: 700, width: 600, height: 20}, // an event from 8:40pm to 9pm
        ...
        var aEvents = oCalendarController.layoutEvents(aEvents, 620, 720).getAllEvents();
        assert.deepEqual(aEvents, aExpected);
      });
    });
    describe('showCalendar', function () {
      ...
      var oTemplate = new demo.app.Template();
        ...
        oCalendarController.removeAllEvents();
           var aEvents = [
          { id: 1, start: 0, end: 70},
          { id: 2, start: 30, end: 140},
          { id: 3, start: 60, end: 300},
          { id: 4, start: 80, end: 160},
          { id: 5, start: 140, end: 180},
          { id: 6, start: 160, end: 340},
          { id: 7, start: 400, end: 460},
          { id: 8, start: 30, end: 70}
        ];
